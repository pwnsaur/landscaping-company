...
const ProjectsPage = async () => {
  ...
  return (
    <PageShell>
      <Hero>
        <Eyebrow>Projekti</Eyebrow>
        <Title>Piemeri ar realiem teritoriju parveidojumiem</Title>
        <Lead>
          No privatiem pagalmiem lidz lielakam teritorijam. Katrs projekts tiek
          pielagots vietai, lietojumam un ilgtermina uzturesanai.
        </Lead>
      </Hero>
      ...
      {projects.length > 0 ? (
        ...
        <EmptyState>
          Paslaik projektu galerija tiek papildinata. Ja velies redzet lidzigus
          darbus, sazinies ar mums.
        </EmptyState>
      )}

      <CtaPanel>
        <CtaTitle>Nepieciesams lidzigs risinajums?</CtaTitle>
        <CtaText>Apraksti situaciju un sagatavosim ieteicamo darbu planu.</CtaText>
        <CtaLink href='/contacts'>Sazinaties</CtaLink>
      </CtaPanel>
    </PageShell>
  );
};
