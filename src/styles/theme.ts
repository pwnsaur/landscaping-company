...
export const theme = {
  ...
  semantic: {
    ...
    surface: {
      base: colors.surfaceSoft,
      elevated: colors.surfaceElevated,
      elevatedMuted: colors.surfaceElevatedMuted,
      dark: colors.surfaceDark,
      darkSoft: colors.surfaceDarkSoft,
    },
    border: {
      subtle: colors.lineSoft,
      strong: colors.lineStrong,
      accent: colors.lineAccent,
      onDark: colors.lineOnDarkSoft,
      onDarkStrong: colors.lineOnDarkStrong,
    },
    interactive: {
      ghost: colors.interactiveSoft,
      active: colors.interactiveActive,
      disabled: colors.interactiveMuted,
      disabledBorder: colors.interactiveMutedBorder,
